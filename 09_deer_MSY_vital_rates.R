...
constK <- ggplot(constSims) +
  ...
  geom_ribbon(aes(x=Year,ymin=N.20pct, ymax=N.80pct, group=Scenario, fill=Scenario), alpha=0.1) +
  geom_line(aes(x=Year, y=N.median, group=Scenario, color=Scenario), linewidth=1) +
